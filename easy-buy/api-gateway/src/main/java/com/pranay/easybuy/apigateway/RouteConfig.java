...
import com.pranay.easybuy.apigateway.filters.AuthenticationFilter;
...
public class RouteConfig {
    ...
    public RouteLocator route(RouteLocatorBuilder builder) {
        return builder.routes().route("products-service", route -> route.path("/products-service/**").filters(f -> f
                        .filter(authenticationFilter.apply(new AuthenticationFilter.Config())).addRequestHeader("x-api-gateway", "value for api gateway")
