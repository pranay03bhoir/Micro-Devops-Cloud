...
public class ArticleResponseDto {
    ...
    public ArticleResponseDto(Long id, String title, String slug, String shortDesc, String content, String coverImageUrl, Integer readingMinutes, Boolean paid, Status status, Double rating, Double price, Long viewsCount, Long likesCount, Long commentsCount, Boolean isLikedByCurrentUser, Boolean isBookmarkedByCurrentUser, LocalDateTime publishedAt, LocalDateTime createdAt, LocalDateTime updatedAt, CategoryDto category, UserDto user, Set<TagDto> tags) {
        this.id = id;
        this.title = title;
        this.slug = slug;
    ...
    public static class Builder {
        ...
        public Builder isLikedByCurrentUser(Boolean isLikedByCurrentUser) { this.isLikedByCurrentUser = isLikedByCurrentUser; return this; }
        public Builder isBookmarkedByCurrentUser(Boolean isBookmarkedByCurrentUser) { this.isBookmarkedByCurrentUser = isBookmarkedByCurrentUser; return this; }
        ...
        public ArticleResponseDto build() {
            return new ArticleResponseDto(id, title, slug, shortDesc, content, coverImageUrl, readingMinutes, paid, status, rating, price, viewsCount, likesCount, commentsCount, isLikedByCurrentUser, isBookmarkedByCurrentUser, publishedAt, createdAt, updatedAt, category, user, tags);
        }
    }
